...
helm install kube-prometheus-stack prometheus-community/kube-prometheus-stack --namespace monitoring --create-namespace --version=62.3.1 --values=./helm-config/kube-prometheus-stack/values.yml
helm install tempo-release grafana/tempo --namespace monitoring --version=1.10.3
helm install loki grafana/loki-stack --namespace monitoring --version=2.10.2
